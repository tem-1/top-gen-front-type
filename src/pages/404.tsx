...
interface NoutFoundPageProps {}

const NoutFoundPage: FunctionComponent<NoutFoundPageProps> = () => {
  return (
    <div className=" container w-full h-screen flex flex-col lg:flex-row items-center justify-center space-y-16 lg:space-y-0 space-x-8 2xl:space-x-0">
      <div className="w-full lg:w-1/2 flex flex-col items-center justify-center lg:px-2 xl:px-0 text-center">
        <p className="text-7xl md:text-8xl lg:text-9xl font-bold tracking-wider text-gray-300">
          404
        </p>
        <p className="text-2xl md:text-2xl lg:text-xl font-bold tracking-wider text-gray-300 mt-2">
          Таны хайсан хуудас олдсонгүй
        </p>
        <p className="text-sm md:text-sm lg:textsm2xl text-gray-500 my-12">
          Таны хайсан хуудас байхгүй, аль эсвэл өөр хаяг руу өөрчлөгдсөн байна.
          Хэрэв та алдаа гэж бодож байвал бидэнтэй холбогдоно уу.
        </p>
        <Link
          href="/"
